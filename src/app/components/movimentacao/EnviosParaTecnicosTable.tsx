// app/components/movimentacao/EnviosParaTecnicosTable.tsx
'use client';
...
export function EnviosParaTecnicosTable({ movimentacoes }: Props) {
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><ArrowLeftRight size={24}/> Envios para Técnicos</h2>
